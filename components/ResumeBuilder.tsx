    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-900 rounded-lg shadow-lg">
      <div className="mb-6">
        ...
        <form onSubmit={generateResume} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full p-2 bg-green-400 text-gray-900 rounded-md hover:bg-green-500 transition-colors"
          >
        ...
        <div className="bg-gray-800 p-6 rounded-md">
          ...
          <div className="space-y-4">
            <div className="text-center border-b border-gray-700 pb-4">
              <p className="text-white font-bold text-lg">{generatedResume.header.split('\n')[0]}</p>
              <p className="text-gray-400 text-sm">{generatedResume.header.split('\n')[1]}</p>
            </div>
            
            {generatedResume.sections.map((section, index) => (
              <div key={index}>
                <h4 className="text-green-400 font-semibold">{section.title}</h4>
