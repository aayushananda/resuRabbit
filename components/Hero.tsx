            ...
            <div className="w-[692px] flex items-center justify-center"> 
                <div className="w-[692px] flex-col"> 
                    ...
                    <div className="mt-6 flex gap-6 pt-4">
                        <button className="border-2 bg-[#6300B3] py-2 w-36 border-[#6300B3] text-white font-semibold rounded-sm">Resume Builder</button>
                        <button className="border-2 bg-[#6300B3] py-2 w-36 border-[#6300B3] text-white font-semibold rounded-sm">Resume Score</button>
                    </div>
                </div>
