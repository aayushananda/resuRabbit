            ...
            <div className="w-[692px] flex items-center justify-center"> 
                <div className="w-[692px] flex-col"> 
                    ...
                    <div className="mt-6 flex gap-6 pt-4">
                        <Link href="/resume-builder"><button className="border-2 bg-[#6300B3] py-2 w-36 border-[#6300B3] text-white font-semibold rounded-sm">Resume Builder</button></Link>
                        <Link href="/resume-scorer"><button className="border-2 bg-[#6300B3] py-2 w-36 border-[#6300B3] text-white font-semibold rounded-sm">Resume Score</button></Link>
                    </div>
                </div>
